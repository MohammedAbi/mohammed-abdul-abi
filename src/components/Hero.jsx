  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 animate-fade-in">
        ...
        {/* Name */}
        <h1
          className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 animate-fade-in"
        ...
        >
          Full Front-End Developer passionate about creating beautiful,
